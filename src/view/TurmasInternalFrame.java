...
public class TurmasInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("  Nova  "));
    ...
    private void DelTurmaBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DelTurmaBtnActionPerformed
        ...
        if (idx.length > 0) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                    ...
                    else { JOptionPane.showMessageDialog(null, " Não é possível excluir uma turma em uso. ", "Atenção", JOptionPane.WARNING_MESSAGE); }
